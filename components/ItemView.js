    ...
    <div class="container">
      <div class="row ">
        <div class="col-md-6 text-center">
          <img width="100%" src="iphone.png" alt=""   data-toggle="modal" data-target=".bd-example-modal-lg" /><br /><br />
    ...
    <div class="modal-dialog modal-lg modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <img width="100%" src="iphone.png" alt=""   />
          ...
          <div class="row">
            <div class="col-6">
              <button id="pr{{i.id}}" class="btn-block commonbutton5  slight-big">BUY NOW</button>
            </div>
            <div class="col-6">
              <a href="/shop/products/{{i.id}}">
                <button id="qv{{i.id}}" class="btn-block commonbutton5    slight-big">ADD TO CART
                        </button>
              </a>
            </div>
          </div>
